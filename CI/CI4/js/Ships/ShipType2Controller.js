...
class ShipType2Controller extends ShipController {
    constructor(x, y, namePlayer, configs) {
        ...
        configs.frameNameDefault = 'Spaceship2-' + namePlayer + '.png';
        configs.frameNameLeft = 'Spaceship2Left-' + namePlayer + '.png';
        configs.frameNameRight = 'Spaceship2Right-' + namePlayer + '.png';
        configs.radius = 32;
        super(x, y, 'Spaceship2-' + namePlayer + '.png', configs);
